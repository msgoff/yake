                ...
                if len(n_gram_word_list[0].split(" ")) == 1:
                    ...
                    if kw_list.index(min_score_word) == 0:
                        ...
                        if temporal_kw in relevant_words_array:
                            try:
                                if relevant_words_array.index(
                                    temporal_kw
                                ) > relevant_words_array.index(
                                    final_splited_text[-1] + " " + temporal_kw
                                ) and not re.findall(
                            ...
                            for tmp_kw in splited_n_gram_kw_list[0][
                                :index_of_more_relevant
                            ]:
